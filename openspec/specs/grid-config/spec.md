...
Définit le comportement de la modale de configuration de la grille vidéo : choix du nombre de colonnes, de lignes et de la largeur, persistance et application à la grille et à la pagination.
