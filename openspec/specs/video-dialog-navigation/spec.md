# Spec: Video Dialog Navigation

## Purpose

Définit le comportement de navigation entre vidéos au sein du dialog vidéo : zones cliquables latérales, buffer autonome cross-page, navigation clavier, et bouton de tirage aléatoire.
